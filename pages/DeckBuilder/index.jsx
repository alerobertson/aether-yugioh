                    ...
                    <div className="main_container main_container--inner flex">
                        <div className="preview-box_wrap">
                            ...
                            <Card.Body>
                                    ...
                                    <ListGroup.Item>Deck Size: {this.state.deck_cards.length+this.state.extra_cards.length}</ListGroup.Item>
                                    <ListGroup.Item>Main Size: {this.state.deck_cards.length}</ListGroup.Item>
                                    <ListGroup.Item>Extra Size: {this.state.extra_cards.length}</ListGroup.Item>
                                  </ListGroup>
                                  </Card.Body>
                            </Card>
                            </div>
                        ...
                        <div className="deck-box_wrap">
                            <div className="deck-box flex flex--wrap mx-2" style={{backgroundColor: "rgba(160, 124, 130, 0.5)" , padding:"6px"}}>
                                {deck_card_template}
                            </div>
                            <div className="deck-box deck-box--extra flex flex--wrap mx-2 mt-2" style={{backgroundColor: "rgba(160, 55, 155, 0.5)", padding:"6px"}}>
                                {extra_card_template}
                                {["old"].includes(deck_id) &&
                        ...
                        <Deckbox box_cards={this.state.box_cards} onClickHandler={this.onBoxCardClick} onMouseEnterhandler={this.onCardHover} />
                    </div>
                </div>
            </main>
    )
